...
function sum()
{
	...
	//Add Recycle
	var s5l_value = document.getElementById('recycle_last').value;
    var s5_value = document.getElementById('recycle').value;

    var s5_result = parseInt(s5_value) - parseInt(s5l_value);
    if (!isNaN(s5_result)) {
        document.getElementById('recycle_total').value = s5_result;
    }
}
...
function sumWwtp()
{
    ...
    //Add wwtp out2
    var wwtp_out21_value = document.getElementById('wwtp_out2_last').value;
    var wwtp_out2_value = document.getElementById('wwtp_out2').value;

    var wwtp_out2_result = parseInt(wwtp_out2_value) - parseInt(wwtp_out21_value);
    if (!isNaN(wwtp_out2_result)) {
        document.getElementById('wwtp_out2_pemakaian').value = wwtp_out2_result;
    }
	//End Add
