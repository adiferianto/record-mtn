    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form class="user" action="<?= base_url(); ?>/users/update/<?= $user['id']; ?>" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="hidden" class="form-control" id="id" name="id" value="<?= old('id') ? old('id') : $user['id']; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="password" class="form-control <?= ($validation->hasError('password')) ? 'is-invalid' : ''; ?>" name="password" id="password" value="<?= old('password') ? old('password') : $user['password']; ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control  <?= ($validation->hasError('level')) ? 'is-invalid' : ''; ?>" id="level" name="level">
                                    <option value="<?= old('level') ? old('level') : $user['level']; ?>" selected><?php if ($user['level'] == '1') : ?> Admin <?php elseif ($user['level'] == '2') : ?> Moderator <?php else : ?> User <?php endif; ?></option>
                        ...
                        <div class="card-footer">
                            <div class="form-group row mb-1 p-2">
                                ...
                                <div class="col-sm-6">
                                    <a href="<?= base_url(); ?>/users" class="btn btn-warning btn-user btn-block">Batal</a>
                                </div>
                            </div>
                        </div>
                    </form>
